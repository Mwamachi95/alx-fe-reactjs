...
const LandingPage = () => {
  return (
    <div className="bg-gradient-to-b from-tazama-yellow to-tazama-blue">
      ...
      <section className="h-screen bg-tazama-blue bg-opacity-90 text-white flex flex-col justify-center">
        <div className="container mx-auto px-4 text-center">
          ...
          <Link 
            to="/home" 
            className="bg-tazama-yellow text-tazama-blue font-bold py-3 px-8 rounded-full hover:bg-opacity-90 transition-all"
          >
            Let's Go
          </Link>
      ...
      {/* Footer */}
      <footer className="bg-tazama-blue py-6">
        <div className="container mx-auto px-4">
          <div className="flex justify-center space-x-6">
            {/* GitHub icon */}
            <a href="#" className="text-white hover:text-tazama-yellow transition-colors">
          ...
          <p className="text-center text-white mt-4 text-sm">
            © {new Date().getFullYear()} Tazama Movie Database
          </p>
        </div>
      </footer>
    </div>
